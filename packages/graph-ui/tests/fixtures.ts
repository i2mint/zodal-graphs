...
export const reactFlowCaps: RendererCapabilities = {
  ...
  watchesValues: true,
  intervals: false,
  traversalOverlays: ['path', 'ancestors', 'descendants', 'cycles', 'topological', 'critical-path'],
  views: ['node-link'],
...
export const sigmaCaps: RendererCapabilities = {
  ...
  watchesValues: false,
  intervals: false,
  traversalOverlays: ['path', 'ancestors', 'descendants', 'components', 'community', 'centrality'],
  views: ['node-link'],
